# Generated by Django 5.1.1 on 2024-12-16 22:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price', models.DecimalField(decimal_places=2, default=0.0, help_text='Total price of the order', max_digits=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(help_text='The user who placed the order', on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='client.customuser')),
            ],
            options={
                'verbose_name': 'Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.ForeignKey(help_text='The vendor who owns this product', on_delete=django.db.models.deletion.CASCADE, related_name='products', to='client.customuser')),
            ],
            options={
                'verbose_name': 'Product',
                'verbose_name_plural': 'Products',
                'ordering': ['-sold_count', 'name'],
            },
        ),
        migrations.CreateModel(
            name='OrderItem',
